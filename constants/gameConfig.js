...
export const GAME_CONFIGS = {
  ...
  league: {
    ...
    visual: () => (
      <div className="flex flex-col items-center justify-center h-full">
        <div className="w-48 h-48 rounded-2xl bg-[var(--primary)] dark:bg-[var(--secondary)] shadow-2xl mb-6 relative overflow-hidden p-2 h-full">
  ...
  national: {
    ...
    visual: () => (
      <div className="flex flex-col items-center justify-center text-[var(--text)] h-full">
        <div className="w-48 h-48 rounded-2xl bg-[var(--primary)] dark:bg-[var(--secondary)] shadow-2xl mb-6 relative overflow-hidden p-2 h-full">
          {/* Fondo de cancha táctico */}
          <div className="absolute inset-0 bg-green-500 rounded-xl overflow-hidden">
            <div className="absolute inset-0 border-2 border-white opacity-70"></div>
