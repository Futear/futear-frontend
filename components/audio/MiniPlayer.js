      ...
      {isMobile ? (
        <div className="flex flex-col gap-1">
          <div className="flex items-center justify-between gap-2">
            <div
              onClick={open}
              className="flex items-center gap-2 min-w-0 flex-1 cursor-pointer transition-colors duration-300"
            ...
            >
              <div className="relative overflow-hidden rounded-md flex-shrink-0">
                ...
                />
                <div
                  className={`absolute inset-0 transition-opacity transform-colors duration-300 ${
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div
            onClick={open}
            className="flex items-center gap-3 min-w-0 w-80 cursor-pointer transition-colors duration-300"
            onMouseEnter={() => setIsHovering(true)}
            onMouseLeave={() => setIsHovering(false)}
          >
            <div className="relative overflow-hidden rounded-md flex-shrink-0">
